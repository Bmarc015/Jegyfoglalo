...
<body>
    <div class="ticket-page">
        <div class="header">
            <img src="./teamlogo/logo.png" class="logo">
            <h1>BELÉPŐJEGY</h1>
        ...
        <div class="match-box">
            ...
            <span class="value">{{ $ticket->game->team_home->team_name }} vs
                {{ $ticket->game->team_away->team_name }}</span>
            <br><br>
        ...
        <table class="details-table">
            <tr>
                <td><span class="label">Szektor</span><span
                        class="value">{{ $ticket->seat->sector->sector_number }}</span></td>
            ...
            <tr>
                ...
                <td><span class="label">Jegy ára</span><span
                        class="value price-tag">{{ number_format($ticket->seat->sector->sector_price, 0, ',', ' ') }}
                        Ft</span></td>
        ...
        <div class="qr-section">
            <img
                src="data:image/svg+xml;base64,{{ base64_encode(QrCode::size(150)->generate('TICKET-ID:' . $ticket->id)) }}">
